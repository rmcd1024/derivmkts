...
vectorized. The function |bsopt| by default provides option
greeks. Here are some examples:
...
The `greeks` function enables you to  compute the greeks for the power
contract:
<<>>=
greeks(powercontract(s=40, v=.08, r=0.08, tt=0.25, d=0, a=2))
@

You can compute the greeks for a spread by defining the value of the
spread as a function, and then computing the greeks for the function:
<<>>=
